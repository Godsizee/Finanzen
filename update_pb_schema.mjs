    ...
    try {
        ...
        try {
            ...
            const setRules = {
                ...
                createRule: '@request.auth.id != "" && created_by = @request.auth.id && settled_with = @request.auth.partner',
        ...
        try {
            ...
            const txRules = {
                ...
                createRule: '@request.auth.id != "" && (paid_by = @request.auth.id || paid_by = @request.auth.partner)',
            ...
            await pb.collections.create({
                ...
                fields: [
                    ...
                    { name: 'category', type: 'relation', collectionId: categoriesId, maxSelect: 1, required: false },
                    { name: 'settlement_id', type: 'relation', collectionId: settlementsId, maxSelect: 1, required: false },
        ...
        try {
            ...
            await pb.collections.create({
                ...
                fields: [
                    ...
                    { name: 'amount', type: 'number', required: true },
                    { name: 'category', type: 'relation', collectionId: categoriesId, maxSelect: 1, required: true },
                    { name: 'paid_by', type: 'relation', collectionId: usersCollection.id, maxSelect: 1, required: true },
                    { name: 'split_mode', type: 'text', required: true },
